...
<html>
    ...
    <body>
        ...
        <h1 class="brand" > <span class="fa fa-asterisk fa-spins"></span> Shopy.com</h1>
 
        <%@include file="admin_navbar.jsp" %>
        
        
        
        <div class="pt-3 pb-3 border-bottom" style="color: black; text-align: center; font-size: 30px; font-weight: 50px">Cancel Order <i class='fas fa-cart-arrow-down'></i></div>
