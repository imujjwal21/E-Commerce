...
<html>
    ...
    <body>
        ...
        <div class="pt-3 pb-3 border-bottom" style="color: black; text-align: center; font-size: 30px; font-weight: 50px">Order Received <i class='fas fa-cart-arrow-down'></i></div>
...
<h3 class="text-warning text-center mt-5 pb-3 font-italic">Order Cancel Successfully!</h3>
...
<h3 class="text-warning text-center mt-5 pb-3 font-italic">Successfully Updated!</h3>
...
%>    
  ...
  <tbody>
    ...
    <tr>
        ...
        <td><a href="../cancelDelivered?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>&status=cancel">Cancel <i class='fas fa-window-close'></i></a></td>
        <td><a href="../cancelDelivered?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>&status=delivered">Delivered <i class='fas fa-dolly'></i></i></a></td>
